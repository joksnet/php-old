...
class Admin_Inmuebles_Paginas_Editar_Contacto_Contenido extends Controller
{
    protected $idioma;
    ...
    public function post()
    {
        ...
        return "/admin/inmuebles/$this->inmuebleCodigo/paginas/$this->paginaCodigo?contacto=$this->idioma";
    }
}