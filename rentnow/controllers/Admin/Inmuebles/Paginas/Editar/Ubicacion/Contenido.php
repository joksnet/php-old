...
class Admin_Inmuebles_Paginas_Editar_Ubicacion_Contenido extends Controller
{
    protected $idioma;
    ...
    public function post()
    {
        ...
        return "/admin/inmuebles/$this->inmuebleCodigo/paginas/$this->paginaCodigo?ubicacion=$this->idioma";
    }
}