...
class Admin_Inmuebles_Paginas_Editar_Ubicacion extends Controller
{
    ...
    public function validation()
    {
        return array(
            ...
            'width'     => array( 'required', 'number' ),
            'height'    => array( 'required', 'number' ),

            'zoom'      => array( 'required', 'number' )
        );
    }
    ...
    public function post()
    {
        ...
        return "/admin/inmuebles/$this->inmuebleCodigo/paginas/$this->paginaCodigo?ubicacion=1";
    }
}