...
class Admin_Inmuebles_Paginas_Editar_Contacto extends Controller
{
    ...
    public function post()
    {
        ...
        return "/admin/inmuebles/$this->inmuebleCodigo/paginas/$this->paginaCodigo?contacto=1";
    }
}